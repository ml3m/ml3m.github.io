...
import BookmarksViewManager from "@/components/bookmarks/BookmarksViewManager";
...
export default function BookmarksPage() {
  return (
    <div className="max-w-[760px] mx-auto px-4 py-6 space-y-4">
      ...
      <p className="text-text-secondary text-center text-[0.85rem] mb-8">
        things i found on the internet that i thought were cool enough to save.
      </p>

      <BookmarksViewManager bookmarks={bookmarks} />
    </div>
  );
}
